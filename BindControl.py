...
class Main(wx.Frame):
    ...
    def __init__(self, guiLogging = True):
        ...
        Profile_new                = ProfMenu.Append(wx.ID_NEW        , "&New\tCTRL-N")
        Profile_load               = ProfMenu.Append(wx.ID_OPEN       , "&Load...\tCTRL-L")
        self.Profile_import        = ProfMenu.Append(wx.ID_ADD        , "&Import Saved Build...\tCTRL-I")
        self.Profile_save          = ProfMenu.Append(wx.ID_SAVE       , "&Save\tCTRL-S")
        self.Profile_saveas        = ProfMenu.Append(wx.ID_SAVEAS     , "Save As...")
        self.Profile_close         = ProfMenu.Append(wx.ID_CLOSE      , "Close")
        ProfMenu.AppendSeparator()
        self.Profile_savedefault   = ProfMenu.Append(wx.ID_ANY        , "Save As Default")
