...
Emotes = {
        'emotes': [
            { 'Converse' : [
                ...
                '---',
                'Chat', 'Lecture', 'Explain',
                '---',
                'Nod', 'ThumbsUp', 'Shrug', 'Thanks', 'Welcome', 'You\'re Welcome|YoureWelcome',
                '---',
                'Disagree', 'Shake Head|No', 'Yada Yada Yada|Yata', 'Talk to the Hand|TalkToHand',
            ]},
            { 'Interact' : [] },
            { 'Actions'  : [] },
            { 'Idle'     : [] },
