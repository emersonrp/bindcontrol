...
MiscPowers = {
    ...
    'Vanity Pets' : {
        ...
        'M-P' : [
            ...
            'Pet: Mini Adamastor',
            'Pet: Mini Arachnos Flyer',
            'Pet: Mini Avatar of Achlys',
            'Pet: Mini Babbage',
            'Pet: Mini Benefactor in the Fog',
            'Pet: Mini Caleb',
            'Pet: Mini Clockwork Paladin',
            'Pet: Mini Council War Walker',
            'Pet: Mini Deathsurge',
            'Pet: Mini Eochai',
            'Pet: Mini Freakshow Tank',
            'Pet: Mini Ghost of Scrapyard',
            'Pet: Mini Hellions Thug',
            'Pet: Mini Hero 1',
            'Pet: Mini Jack In Irons',
            'Pet: Mini Jurassik',
            'Pet: Mini Kheldian Black Dwarf',
            'Pet: Mini Kheldian Bright Nova',
            'Pet: Mini Kheldian Dark Nova',
            'Pet: Mini Kheldian White Dwarf',
            'Pet: Mini Kraken',
            'Pet: Mini Kronos Titan',
