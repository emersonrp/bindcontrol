...
class qwyNumpad(wx.Panel):
    ...
    def GetKeyBinds(self):
        ps = GameData.MMPowerSets
        mmp = ps.get(self.Page.Profile.Primary()) or ps['Mercenaries']
        names = []
        for i in range(6):
    ...
    def PopulateBindFiles(self):
        ...
        ResetFile.SetBind('SHIFT+DECIMAL', '', page, [f'petselectname {uniq[3]}', profile.BLF('mmqn', '2selsh.txt')])
        ...
        # All-pets file
        AllFile = profile.GetBindFile('mmqn', 'all.txt')
        AllFile.SetBind('NUMPAD4', '', page, 'petcomall def')
        AllFile.SetBind('NUMPAD5', '', page, 'petcomall agg')
        AllFile.SetBind('NUMPAD6', '', page, 'petcomall pas')
        AllFile.SetBind('NUMPAD7', '', page, 'petcomall sta')
        AllFile.SetBind('NUMPAD8', '', page, 'petcomall att')
        AllFile.SetBind('NUMPAD9', '', page, 'petcomall got')
        AllFile.SetBind('DIVIDE', '', page, ['show chat', 'beginchat /petsayall '])
        AllFile.SetBind('SUBTRACT', '', page, 'petcomall fol')
        AllFile.SetBind('ALT+NUMPAD0', '', page, 'petcomall dis')
        AllFile.SetBind('ALT+NUMPAD7', '', page, 'petcomall def sta')
        AllFile.SetBind('ALT+NUMPAD8', '', page, 'petcomall def att')
        AllFile.SetBind('ALT+NUMPAD9', '', page, 'petcomall def got')
        AllFile.SetBind('ALT+SUBTRACT', '', page, 'petcomall def fol')
        AllFile.SetBind('SHIFT+NUMPAD7', '', page, 'petcomall agg sta')
        AllFile.SetBind('SHIFT+NUMPAD8', '', page, 'petcomall agg att')
        AllFile.SetBind('SHIFT+NUMPAD9', '', page, 'petcomall agg got')
        AllFile.SetBind('SHIFT+SUBTRACT', '', page, 'petcomall agg fol')
        AllFile.SetBind('CTRL+NUMPAD7', '', page, 'petcomall pas sta')
        AllFile.SetBind('CTRL+NUMPAD8', '', page, 'petcomall pas att')
        AllFile.SetBind('CTRL+NUMPAD9', '', page, 'petcomall pas got')
        AllFile.SetBind('CTRL+SUBTRACT', '', page, 'petcomall pas fol')
        ...
        for i, grp in enumerate(['mins', 'lts']):
            ...
            GrpFile.SetBind('ALT+NUMPAD0', '', page, 'nop')
        ...
        Minalt1SelectFile = profile.GetBindFile('mmqn', '1selalt.txt')
        Minalt1SelectFile.SetBind('ALT+DECIMAL', '', page, [f'petselectname {uniq[0]}', profile.BLF('mmqn', '2selalt.txt')])

        Minalt2SelectFile = profile.GetBindFile('mmqn', '2selalt.txt')
        Minalt2SelectFile.SetBind('ALT+DECIMAL', '', page, [f'petselectname {uniq[1]}', profile.BLF('mmqn', '3selalt.txt')])

        Minalt3SelectFile = profile.GetBindFile('mmqn', '3selalt.txt')
        Minalt3SelectFile.SetBind('ALT+DECIMAL', '', page, [f'petselectname {uniq[2]}', profile.BLF('mmqn', '1selalt.txt')])

        Minsh1SelectFile = profile.GetBindFile('mmqn', '1selsh.txt')
        Minsh1SelectFile.SetBind('SHIFT+DECIMAL', '', page, [f'petselectname {uniq[3]}', profile.BLF('mmqn', '2selsh.txt')])
