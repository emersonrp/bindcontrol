...
#        LBSB = wx.StaticBox(PetNameSB, style = wx.ALIGN_CENTER|wx.NO_BORDER)
#        LabelBox = wx.StaticBoxSizer(LBSB, wx.VERTICAL)
#        self.PetNameLabel = wx.StaticText(LBSB, label = "Pet Name:", style=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT)
#        self.PetKeyLabel  = wx.StaticText(LBSB, label = "Select by Name:", style=wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT)
#        LabelBox.Add(self.PetNameLabel,               1, flag=wx.EXPAND)
#        LabelBox.Add(self.PetKeyLabel,                1, flag=wx.EXPAND)
#        LabelBox.Add(wx.StaticText(LBSB, label = ''), 1)
#
#        PetInner.Add(LabelBox, 0, wx.EXPAND|wx.ALL, 3)
        ...
        for i in range(6):
            ...
            button = bcKeyButton(PBSB, -1, init = {
                ...
                'ToolTip'  : f'Choose the key that will select pet {i+1}',
        ...
        self.RenamePetsButton = bcKeyButton(PetNameSB, -1, init = {
                'CtlName'  : 'RenamePets',
                'CtlLabel' : RenameLabel,
                'Key'      : self.Init['RenamePets'],
            })
        self.RenamePetsButton.SetToolTip('Rename your pets, in-game, to match the names set in BindControl')
        self.RenamePetsButton.Bind(wx.EVT_BUTTON, self.OnRenamePetsButton)
...
#        self.PetKeyLabel     .Enable(bool(ismm and pset))
    ...
    def OnRenamePetsButton(self, _ = None):
        ...

    def OnLevelChanged(self, _ = None):
        ...
