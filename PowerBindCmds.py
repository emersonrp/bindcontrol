...
def match1arg(string, arg1, arg2match = r'\S*'):
    match = re.match(f"^{arg1} ({arg2match})", string)
    if match: return match.group(1)

def match2arg(string, arg1, arg2match = r'\S*', arg3match = r'\S*'):
    match = re.match(f"^{arg1} ({arg2match}) ({arg3match})", string)
