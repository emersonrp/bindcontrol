...
class CameraCmd(PowerBinderCommand):
    ...
    def Deserialize(self, init) -> None:
        ...
        self.mouselookch.SetStringSelection(init.get('mouselookch', ''))
        self.lookupcb.SetValue(init.get('lookupcb', False))
        self.lookupch.SetStringSelection(init.get('lookupch', ''))
        self.lookdowncb.SetValue(init.get('lookdowncb', False))
        self.lookdownch.SetStringSelection(init.get('lookdownch', ''))
        self.firstcb.SetValue(init.get('firstcb', False))
        self.firstch.SetStringSelection(init.get('firstch', ''))
        self.thirdcb.SetValue(init.get('thirdcb', False))
        self.thirdch.SetStringSelection(init.get('thirdch', ''))
