...
class HideUnhideCmd(PowerBinderCommand):
    ...
    def BuildUI(self, dialog) -> wx.BoxSizer:
        ...
        self.HideShowDialog = wx.RadioButton(dialog, label = "Show Hide Dialog", style = wx.RB_GROUP)
        self.HideShowDialog.Bind(wx.EVT_RADIOBUTTON, self.SynchronizeUI)
        self.HideSet        = wx.RadioButton(dialog, label = "Hide from...")
        self.HideSet       .Bind(wx.EVT_RADIOBUTTON, self.SynchronizeUI)
        self.Unhide         = wx.RadioButton(dialog, label = "Unhide from...")
        ...
        self.HSearches   = wx.CheckBox(dialog, label = "Searches")
        self.HSupergroup = wx.CheckBox(dialog, label = "Supergroup")
        self.HFriends    = wx.CheckBox(dialog, label = "Friends")
        self.HGFriends   = wx.CheckBox(dialog, label = "Global Friends")
        self.HGChannels  = wx.CheckBox(dialog, label = "Global Channels")
        self.HTells      = wx.CheckBox(dialog, label = "Tells")
        self.HInvites    = wx.CheckBox(dialog, label = "Invites")
