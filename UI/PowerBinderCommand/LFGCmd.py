...
class LFGCmd(PowerBinderCommand):
    ...
    def BuildUI(self, dialog) -> wx.BoxSizer:
        ...
        self.LFGSetRB = wx.RadioButton(dialog, label = "Looking for", style = wx.RB_GROUP)
        ...
        self.LFGSetChoice = wx.Choice(dialog, choices = list(LFGSet_Numbers.keys()))
        sizer.Add(self.LFGSetChoice, (0,1), (1,0), wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5)
        self.LFGSetChoice.SetSelection(0)

        self.LFGRemoveRB = wx.RadioButton(dialog, label = "Remove from LFG queue")
        ...
        self.LFGToggleRB = wx.RadioButton(dialog, label = "Toggle LFG Status")
        ...
        self.CommentCB = wx.CheckBox(dialog, label = "Set Search Comment")
        ...
        self.Comment = wx.TextCtrl(dialog)
