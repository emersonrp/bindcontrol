...
class UseInspRowColCmd(PowerBinderCommand):
    ...
    def BuildUI(self, dialog) -> wx.BoxSizer:
        ...
        useInspRowColumnSizer.Add(wx.StaticText(dialog, label = "Row:"), 0,
                wx.ALIGN_CENTER_VERTICAL|wx.RIGHT, 4)
        self.useInspRowColumnRow = wx.Choice(dialog, choices=['1','2','3','4', 'Bottom'], style=wx.ALIGN_CENTER_VERTICAL)
        self.useInspRowColumnRow.SetSelection(0)
        useInspRowColumnSizer.Add(self.useInspRowColumnRow, 0, wx.ALIGN_CENTER_VERTICAL)
        useInspRowColumnSizer.Add(wx.StaticText(dialog, label = "Column:"), 0,
                wx.ALIGN_CENTER_VERTICAL|wx.LEFT|wx.RIGHT, 4)
        self.useInspRowColumnCol = wx.Choice(dialog, choices=['1','2','3','4','5'], style=wx.ALIGN_CENTER_VERTICAL)
