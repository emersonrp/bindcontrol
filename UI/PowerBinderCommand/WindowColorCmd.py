...
class WindowColorCmd(PowerBinderCommand):
    ...
    def BuildUI(self, dialog) -> wx.BoxSizer:
        ...
        self.ColorBorder  = wx.Panel(dialog, size = wx.Size(150, 150))
        borderSizer = wx.BoxSizer(wx.VERTICAL)
        self.ColorBorder.SetSizer(borderSizer)
        self.ColorDisplay = wx.StaticText(self.ColorBorder, size = wx.Size(140, 140))
        ...
        self.RSlider = wx.Slider(dialog, size = wx.Size(300, -1), value = 36, minValue = 0, maxValue = 255)
        self.RSlider.Bind(wx.EVT_SCROLL, self.UpdateFromSlider)
        RGBASizer.Add(self.RSlider, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 3)
        self.RReadout = wx.SpinCtrl(dialog, initial = 128, min = 0, max = 255)
        ...
        self.GSlider = wx.Slider(dialog, size = wx.Size(300, -1), value = 145, minValue = 0, maxValue = 255)
        self.GSlider.Bind(wx.EVT_SCROLL, self.UpdateFromSlider)
        RGBASizer.Add(self.GSlider, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 3)
        self.GReadout = wx.SpinCtrl(dialog, initial = 128, min = 0, max = 255)
        ...
        self.BSlider = wx.Slider(dialog, size = wx.Size(300, -1), value = 255, minValue = 0, maxValue = 255)
        self.BSlider.Bind(wx.EVT_SCROLL, self.UpdateFromSlider)
        RGBASizer.Add(self.BSlider, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 3)
        self.BReadout = wx.SpinCtrl(dialog, initial = 128, min = 0, max = 255)
        ...
        self.ASlider = wx.Slider(dialog, size = wx.Size(300, -1), value = 255, minValue = 0, maxValue = 255)
        self.ASlider.Bind(wx.EVT_SCROLL, self.UpdateFromSlider)
        RGBASizer.Add(self.ASlider, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 3)
        self.AReadout = wx.SpinCtrl(dialog, initial = 128, min = 0, max = 255)
