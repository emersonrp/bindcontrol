...
def test_main_menubar(app):
    ...
    assert helpmenu.GetMenuItemCount() == 5
    ...
    assert helpmenu.FindItemByPosition(2).GetItemLabel() == "License Info"
    assert helpmenu.FindItemByPosition(3).GetItemLabel() == "Reporting Bugs"
    assert helpmenu.FindItemByPosition(4).GetItemLabel() == "&About"
